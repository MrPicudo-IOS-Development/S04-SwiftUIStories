/* MyStory.swift --> Stories. Created by Miguel Torres on 09/04/2023 */

import SwiftUI

// Variable global a la que accedemos como "story" cada vez que lo necesitemos, desde cualquier otro archivo del proyecto.
let story = Story(pages: [
    StoryPage( // 0
        // Con tres comillas dobles de apertura y de cierre, podemos escribir libremente con saltos de línea, comillas para el texto y sin necesidad de comas, ni nada, todo lo que esté dentro es la cadena.
        """
